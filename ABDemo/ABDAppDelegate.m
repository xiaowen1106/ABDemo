...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    ABDMasterViewController *firstViewController = (ABDMasterViewController *)[[navigationController viewControllers] objectAtIndex:0];
    
    ABDContactController *aDataController = [[ABDContactController alloc] init];
    firstViewController.contactController = aDataController;
